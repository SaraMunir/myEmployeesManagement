            ...
            <div key={`post${idx}`} className={ theme === 'Dark' ? " myCardDark  mx-auto" : " myCard mx-auto"}>
                <div className="post">
                    ...
                    <div className="d-flex col-10 justify-content-between">
                        ...
                        {
                            post.voteId ? <div onClick={()=>downVotePost(post._id)}><i class="onHvr2 fas fa-2x fa-arrow-circle-down"></i></div> : <div onClick={()=>upVotePost(post._id)}><i class="onHvr fas fa-2x fa-arrow-circle-up"></i></div>
                        }
